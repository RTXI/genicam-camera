...
class Mono10Format : public QObject, public QArvPixelFormat {
  ...
  public:
    ...
    QArvDecoder* makeDecoder(QSize size) {
      return new MonoUnpackedDecoder<uint16_t, 10,
ARV_PIXEL_FORMAT_MONO_10>(size);
    }
};
...
class Mono12Format : public QObject, public QArvPixelFormat {
  ...
  public:
    ...
    QArvDecoder* makeDecoder(QSize size) {
      return new MonoUnpackedDecoder<uint16_t, 12,
ARV_PIXEL_FORMAT_MONO_12>(size);
    }
};
...
class Mono14Format : public QObject, public QArvPixelFormat {
  ...
  public:
    ...
    QArvDecoder* makeDecoder(QSize size) {
      return new MonoUnpackedDecoder<uint16_t, 14,
ARV_PIXEL_FORMAT_MONO_14>(size);
    }
};
...
class Mono16Format : public QObject, public QArvPixelFormat {
  ...
  public:
    ...
    QArvDecoder* makeDecoder(QSize size) {
      return new MonoUnpackedDecoder<uint16_t, 16,
ARV_PIXEL_FORMAT_MONO_16>(size);
    }
};
*/
}
