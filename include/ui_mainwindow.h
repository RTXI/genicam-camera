...
public:
  ...
  void setupUi(QMainWindow *MainWindowUI) {
    ...
    QIcon icon;
    //        icon.addFile(QStringLiteral(":/icons/qarv.svgz"), QSize(),
  ...
  void retranslateUi(QMainWindow *MainWindowUI) {
    ...
    closeFileAction->setToolTip(QApplication::translate(
        "MainWindowUI", "Depressing the Record button normally pauses "
                        "recording, which can be resumed. Press this button to "
    ...
    pickROIButton->setToolTip(QApplication::translate(
        "MainWindowUI",
        "Select ROI by drawing a rectangle on the video display.", 0));
#endif // QT_NO_TOOLTIP
    ...
    sliderUpdateSpinbox->setToolTip(QApplication::translate(
        "MainWindowUI", "Exposure and gain are periodically updated and "
                        "sliders moved accordingly.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    statusTimeoutSpinbox->setToolTip(QApplication::translate(
        "MainWindowUI", "A message is shown in the status bar on certain "
                        "events or errors. This message is cleared after the "
                        "specified interval.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    streamFramesSpinbox->setToolTip(QApplication::translate(
        "MainWindowUI",
        "<html><head/><body><p>This setting controls the number of frames "
        "standing ready for camera to fill, ensuring smooth operation. If the "
        "frames arrive faster than they can be decoded and/or recorded, the "
        "buffer will underflow. If this happens intermittently, increase the "
        "buffer size. It it happens regularly, your system is too slow to "
        "handle the workload.</p></body></html>",
        0));
#endif // QT_NO_TOOLTIP
    ...
    nocopyCheck->setToolTip(QApplication::translate(
        "MainWindowUI",
        "If this option is selected, as little copying of images is done as "
        "possible, making the program significantly faster. But, if the "
        "computer is too slow to process images in a timely manner, it may "
        "happen that the camera will be faster and will overwrite a current "
    ...
    dropInvalidFrames->setToolTip(QApplication::translate(
        "MainWindowUI", "Invalid frames will not be recorded and will be "
                        "displayed as pure red.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    postprocBox->setTitle(QApplication::translate(
        "MainWindowUI", "Image postprocessing chain", 0));
    ...
    recordInfoCheck->setToolTip(QApplication::translate(
        "MainWindowUI", "Raw video formats do not contain any identifying "
                        ...
                        "additional file with a .qarv extension will be "
                        "created and will contain video format information. "
                        "This file can be opened with the qarv video player.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    recordTimestampsCheck->setToolTip(QApplication::translate(
        "MainWindowUI", "An additional file with a .timestamps extension will "
                        "be created and will contain frame timestamps in "
    ...
    recordMetadataCheck->setToolTip(QApplication::translate(
        "MainWindowUI", "Creates an additional file with .caminfo extension. "
                        "It can be loaded using Advanced settings tab.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    stopRecordingFramesRadio->setToolTip(QApplication::translate(
        "MainWindowUI", "Recording will be stopped when the specified number "
                        "of frames is recorded.",
        0));
#endif // QT_NO_TOOLTIP
    ...
    stopRecordingTimeRadio->setToolTip(QApplication::translate(
        "MainWindowUI", "Recording will be stopped when the specified amount "
                        "of time elapses. Time is specified as "
    ...
    label_20->setText(QApplication::translate(
        "MainWindowUI", "<html><head/><body><p>This view provides direct "
                        "access to the camera. Changes may not be reflected in "
                        "the rest of the program.</p></body></html>",
        0));
#ifndef QT_NO_TOOLTIP
